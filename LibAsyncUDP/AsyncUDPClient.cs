...
namespace LibAsyncUDP {
    ...
    public class AsyncUDPClient {
        ...
        public void SendRawData(Byte[] Data) {
            this.Client.BeginSend(Data, Data.Length, this.RemoteEndPoint, new AsyncCallback(this.DefaultSendCallback), null);
        }

        public void SendData(IPackage Package) {
            this.Client.BeginSend(Package.PackageData, (Int32)Package.DataLength, this.RemoteEndPoint, new AsyncCallback(this.DefaultSendCallback), null);
        }
